...
export default function HeroSection({tag,title,body,image='/hero.png',compact=false,highlight}:{tag?:string;title:string;body?:string;image?:string;compact?:boolean;highlight?:string}) {
